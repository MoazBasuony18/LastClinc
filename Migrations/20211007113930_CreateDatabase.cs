        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SpecialHabbit = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PatientDataId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PatientDataForDoctors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PatientDataForDoctors_PatientDatas_PatientDataId",
                        column: x => x.PatientDataId,
                        principalTable: "PatientDatas",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PatientDataForDoctors_PatientDataId",
